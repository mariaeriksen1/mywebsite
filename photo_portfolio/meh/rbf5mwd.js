...
window.Typekit.config = {
    "a": "785707",
    "c": [".franklin-gothic,.tk-franklin-gothic-urw-cond", "\"franklin-gothic-urw-cond\",sans-serif"],
    "fi": [12093],
    "fc": [{
        "id": 12093,
        "family": "franklin-gothic-urw-cond",
        "src": "https://use.typekit.net/af/0ea6a5/0000000000000000000118b5/21/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {
            "weight": "400",
            "style": "normal",
            "subset_id": 2
    ...
    "fn": ["franklin-gothic-urw-cond", ["n4"]],
    "hn": "use.typekit.net",
    "ht": "tk",
    "js": "1.19.2",
    "kt": "rbf5mwd",
